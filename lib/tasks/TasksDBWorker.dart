...
class TasksDBWorker {
  ...
  static const String query =
      'CREATE TABLE IF NOT EXISTS tasks (id INTEGER PRIMARY KEY, description TEXT, dueDate TEXT, completed TEXT)';
  ...
  Future<Task> get(int intID) async {
    Database db = await database;
    var rec = await db.query('tasks', where: 'id=?', whereArgs: [intID]);
